...
namespace P6Travels_API_KevinRodriguez.Models;
...
public partial class P620242travelsContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CountryId).HasName("PK__Country__10D160BF248B7A80");
        ...
        {
            entity.HasKey(e => e.DestionationId).HasName("PK__Destinat__12F2541FDF5E3384");
        ...
        {
            entity.HasKey(e => e.HostingId).HasName("PK__Hosting__B2C2DF84B9ED3960");
        ...
        {
            entity.HasKey(e => e.ReservationId).HasName("PK__Reservat__B7EE5F046B11062E");
        ...
        {
            entity.HasKey(e => e.ActivityId).HasName("PK__Schedule__45F4A7F1CA1B0F72");
        ...
        {
            entity.HasKey(e => e.TourId).HasName("PK__Tour__604CEA10FCDDAD06");
        ...
        {
            entity.HasKey(e => e.TransportId).HasName("PK__Transpor__19E9A17DDB6CB2F0");
        ...
        {
            entity.HasKey(e => e.TravelId).HasName("PK__Travel__E931521562EBB38C");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__User__1788CCAC4B18FCCE");
        ...
        {
            entity.HasKey(e => e.UserRoleId).HasName("PK__UserRole__3D978A55C340D53A");
