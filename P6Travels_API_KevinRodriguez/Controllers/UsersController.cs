...
using P6Travels_API_KevinRodriguez.Models;
using P6Travels_API_KevinRodriguez.ModelsDTOs;

namespace P6Travels_API_KevinRodriguez.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        //segun su correo, y sera usada para cargar la info del usuario
        //justo despues  de lavalidacion del login en la app,
        ...
        { 
            //aca vamos imitar la misma consulta que hicimos en SSMS
            //pero usando Linq
            ...
            var query = (from u in _context.Users
                         ...
                         //los nombres que estan dentro del selec new{}
                         //se usaran de forma temporal para la captura de los
                         //datos que luego se pasaran de DTO de respuesta de la funcion

                //ahora que tenemos la info necesaria, vamos a crear
                //un objeto en la lista del tipo de DTO de respuesta,
        ...
        public async Task<ActionResult<UsuarioDTO>> AddUserFromApp(UsuarioDTO user)
        {
            ...
            //Normalmente usamos herramientas como auto mapper para hacer la transformacion del
            //DTO al modelo nativo (en este caso User). Pero para entender mejor o por mayor
            //control aca haremos el mapeo manualmente
